...
//        System.out.println("————————————————创建 RedisTemplate————————————————");
//        System.out.println("RedisConnectionFactory 信息：");
...
//    private int redisDatabase;
//
//    @Value("${spring.redis.password:未配置}")
//    private String redisPassword;
//
//    @Bean
//    @ConditionalOnMissingBean(name = "redisTemplate")
...
//
//    /**
//     * 自定义RedisTemplate，替换默认的JDK序列化，使用String和Jackson序列化
//     */
//    @Bean
//    @ConditionalOnMissingBean(name = "redisTemplate")
//    public RedisTemplate<String, Object> redisTemplate(RedisConnectionFactory redisConnectionFactory) {
...
//
//        // 设置 Key 的序列化（Redis 默认序列化工具）
//        template.setKeySerializer(stringRedisSerializer);
//        template.setHashKeySerializer(stringRedisSerializer);
//
//        // 设置 Value 的序列化（Jackson 序列化工具）
//        template.setValueSerializer(jsonRedisSerializer);
//        template.setHashValueSerializer(jsonRedisSerializer);
//
//        // 开启事务
